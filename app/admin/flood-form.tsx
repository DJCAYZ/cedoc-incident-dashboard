                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      updated[idx] = {
                        ...updated[idx],
                        level_meters: Number(e.target.value),
                      };
                      setWaterLevels(updated);
                    }}
                    className="bg-slate-950 border border-slate-800 text-white rounded-lg p-1.5 text-center text-sm font-bold focus:ring-2 focus:ring-cyan-600 focus:outline-none"
                  />
                </div>
                <div className="flex flex-col gap-0.5">
                  <label className="text-[9px] text-slate-500 uppercase tracking-wider font-bold">
